...
// This check for height constraints needs to happen *after* screen
// rotation for the web app (height and width are initially zero and
// then, after that, set for portrait, before finally being set for
// landscape).
